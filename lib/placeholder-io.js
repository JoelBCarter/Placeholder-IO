...
var debug = require('debug')('prototype-io');
...
util.inherits(PrototypeIO, BoardIO);

PrototypeIO.prototype.normalize = function(pin) {
...
// PrototypeIO.prototype.pinMode = function(pin, mode) {
...
// PrototypeIO.prototype.pwmWrite = function(pin, value) {
...
// PrototypeIO.prototype.analogWrite = PrototypeIO.prototype.pwmWrite;

// PrototypeIO.prototype.analogRead = function(pin, handler) {
...
// PrototypeIO.prototype.digitalWrite = function(pin, value) {
...
// PrototypeIO.prototype.digitalRead = function(pin, handler) {
...
// PrototypeIO.prototype.i2cConfig = function(options) {
...
// PrototypeIO.prototype.i2cWrite = function(address, cmdRegOrData, inBytes) {
...
// PrototypeIO.prototype.i2cWriteReg = function(address, register, byte) {
...
// PrototypeIO.prototype.i2cRead = function(address, register, size, handler) {
...
// PrototypeIO.prototype.i2cReadOnce = function(address, register, size, handler) {
//   // fix arguments if called with Firmata.js API
//   if (arguments.length === 3 &&
...
// PrototypeIO.prototype._onAnalogRead = function(id, value) {
//   var pin = this._pinsById[id];

//   this.emit('analog-read-' + pin.number, value);
// };

// PrototypeIO.prototype._onDigitalRead = function(id, value) {
//   var pin = this._pinsById[id];

//   this.emit('digital-read-' + pin.number, value);
// };

module.exports = PrototypeIO;